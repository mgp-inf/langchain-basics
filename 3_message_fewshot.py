"""Demonstrates a Gemini API call with LangChain messages including few examples."""
import os
import argparse
...
def main(model_name: str, temperature: float) -> None:
    ...
    question = "What is the meaning of farhanitrateprerajulization?"
    messages = [
        SystemMessage(
            ...
            "You answer stricly fomatted based on the given examples."
        ),
        HumanMessage("DiffAssemble"),
        AIMessage("Combination of: **Diffusion** and **Assembly**, or **Different** and **Assemble**."),
        HumanMessage("What does langchain mean?"),
        AIMessage("Combination of: **Language** and  **Chain**."),
